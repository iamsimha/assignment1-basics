...
from cs336_basics.train_bpe import train_bpe, Tokenizer
...
from cs336_basics.nn_ops import softmax, silu
...
def run_multihead_self_attention(
    ...
    """
    mha = MultiHeadSelfAttn(d_model, num_heads)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    mha = MultiHeadSelfAttn(d_model, num_heads, use_rope=True, theta=theta, max_seq_len=max_seq_len)
    mha.load_state_dict({"q_proj.weight": q_proj_weight,
        "k_proj.weight": k_proj_weight,
        "v_proj.weight": v_proj_weight,
        "output_proj.weight": o_proj_weight}, strict=False)
    return mha(in_features)
...
def run_transformer_lm(
    ...
    transformer = Transformer(d_model, num_layers, num_heads, d_ff,
                        context_length, rope_theta, vocab_size, device=None, dtype=None)
